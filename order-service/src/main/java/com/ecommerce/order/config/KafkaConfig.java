...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, PaymentConfirmedEvent> paymentConfirmedConsumerFactory() {
        JsonDeserializer<PaymentConfirmedEvent> deserializer = new JsonDeserializer<>(PaymentConfirmedEvent.class, false);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PaymentConfirmedEvent> kafkaListenerContainerFactory() {
